...
var death_effect_scene = preload("res://enemies/skeleton/SkeletonDeathEffect.tscn")
...
func _physics_process(delta: float) -> void:
	...
	match state:
		...
		EnemyState.RUNNING:
			...
			animated_sprite.play("walk", false)
...
func _on_EnemyStats_no_health():
	...
	death_position_vector.y = death_position_vector.y - 28
...
var is_preforming_attack = false
...
func _on_Hurtbox_area_entered(_area):
	...
	if state != EnemyState.ATTACKING: animated_sprite.play("damaged", false)
	stats.damage(player_stats.get_attack_power())
	bubble.set_text("HP left: " + stats.get_health() as String)
	
func _on_Timer_timeout():
	if is_in_hitbox_area: player_stats.damage(2)
